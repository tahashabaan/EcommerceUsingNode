...
//     } 
  ...
  const apiFeature =  new ApiFeature(productModal.find(), req.query).filter()

    //execute
    const product =  await apiFeature.mon;
   
    res.status(201).json({result:product.length, page:1, data:product})
})
