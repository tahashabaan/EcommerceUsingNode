...
// @access     private
exports.createUsers =createDocument(createUserValidator,userModel);
...
// @route get api/v1/users
// @acess private
exports.getUserById = getDocumentById(getUserValidator,userModel);


// @desc  updata user in database by id 
// @route put api/v1/users
// @acess private
exports.updataUserById = () => {
  updateUserValidator()
  asyncHandler(async(req, res, next) => {
   ...
   const document  = await userModel.findByIdAndUpdate(id, 
    { name, email, profileImage, phone, active, role }, {new:true})
...
// @acess public
exports.delUserById = deleteDocumentById(deleteUserValidator,userModel);