...
const {getCategory, getCategoryById, createCategory, updateCategory, deleteCategory, filterObj } = require('../services/categoryService');
...
router.route('/:id')
     .get(filterObj, getcatagoryValidator, getCategoryById)
